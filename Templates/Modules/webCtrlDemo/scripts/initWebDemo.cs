...
function webCtrlDemo::lateInitClient( %this )
{
   exec("./customProfiles.cs");
   exec("./demoGui.cs");
   exec("./gui/demoGui.gui");
   exec("./browserGui.cs");
   exec("./gui/browserGui.gui");
   exec("./urlRequest.cs");
   exec("./urlTest.cs");
   exec("./gui/urltester.gui");
   exec("./gui/headerTemplate.gui");
